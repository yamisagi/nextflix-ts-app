...
const HeroSection = async ({
  ...
  return (
    <div className='relative w-full max-w-[100vw] overflow-hidden rounded-md flex flex-col md:flex-row md:items-center'>
...
'
      >
        <p className='text-white text-base md:text-4xl lg:text-4xl font-bold drop-shadow-xl
        text-center
        '>
          {title}
        </p>

        <p className='text-white text-xs md:text-sm xl:text-lg mt-3 md:mt-8 drop-shadow-xl'>
          {overview}
        </p>

        <div className='flex items-center mt-3 md:mt-4 gap-3 text-black hover:text-red'>
          <Link
            href={`/movies/${id}`}
